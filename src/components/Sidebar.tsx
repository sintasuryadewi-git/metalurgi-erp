...
import { 
  ...
  Target, Users, ChevronLeft, Building2, ShoppingBag, Receipt 
} from 'lucide-react';
...
const MENU_ITEMS = [
  ...
  { name: 'Expense Report', path: '/expense-report', icon: Receipt },
  { name: 'Sales Report', path: '/sales-report', icon: ShoppingBag }, // <-- MENU BARU DITAMBAHKAN DI SINI
